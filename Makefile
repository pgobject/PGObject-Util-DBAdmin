# This Makefile is for the PGObject::Util::DBAdmin extension to perl.
#
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Util/DBAdmin.pm
...
TO_INST_PM = lib/PGObject/Util/DBAdmin.pm

PM_TO_BLIB = lib/PGObject/Util/DBAdmin.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Util/DBAdmin.pm $(INST_MAN3DIR)/PGObject::Util::DBAdmin.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''PostgreSQL Database Management Facilities for '\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: PGObject-Util-DBAdmin' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "PostgreSQL Database Management Facilities for ",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Chris Travers <chris@efficito.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "PGObject-Util-DBAdmin",' >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Util/DBAdmin.pm blib/lib/PGObject/Util/DBAdmin.pm 
